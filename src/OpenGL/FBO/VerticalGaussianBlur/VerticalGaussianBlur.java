package OpenGL.FBO.VerticalGaussianBlur;
...
public class VerticalGaussianBlur {
	public FrameBuffer frameBuffer;
	public FBORenderObject fBORenderObject;
	public float width;
	public float height;
	
	public VerticalGaussianBlur(float width, float height, VAO vao, Texture texture, int shaderID){
		this.width = width;
		this.height = height;
	...
	public void sendUniformDataToGPU() {
		OpenGL.floatToGPU(fBORenderObject.getShaderID(), "heightOfFBO", height);
	}
}
