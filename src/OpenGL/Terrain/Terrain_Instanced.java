...
public class Terrain_Instanced extends Entities{
	//Entities index
	public int index = -1;
	...
	//Terrain Properties
	private int numOfInstancesWide;
	private int numOfInstances;
	private float widthPerInstance;
	...
	public Terrain_Instanced(float widthPerInstance, int numOfInstancesWide, VAO vao, Texture texture, int shaderID) {
		this.vao = vao;
		...
		numVertexAttribs = 3; //positions
		//Terrain Properties
		this.numOfInstancesWide = numOfInstancesWide;
		numOfInstances = this.numOfInstancesWide * this.numOfInstancesWide;
		heightIntensity = 6000.0f;
		displacementIntensity = 100.0f;
		
		//Movement
		pos = new Vector3D(-widthPerInstance * numOfInstancesWide / 2, 0.0f, -widthPerInstance * numOfInstancesWide / 2);
		...
		//Scale
		scale = new Vector3D(widthPerInstance/2f, 1.0f, widthPerInstance/2f);
		
		//Set up Textures
		OpenGL.addTextureToShader(shaderID, "colorTexture", 0);
		OpenGL.addTextureToShader(shaderID, "normalMap", 1);
		OpenGL.addTextureToShader(shaderID, "heightMap", 2);
		OpenGL.addTextureToShader(shaderID, "displacementMap", 3);
		OpenGL.addTextureToShader(shaderID, "specularMap", 4);
	...
	public void render(double alpha) {
		...
		RenderOrganizer.bindTexture(2, texture.getHeightMapID());
		OpenGL.floatToGPU(shaderID, "heightIntensity", heightIntensity);
		RenderOrganizer.bindTexture(3, texture.getDisplacementMapID());
		OpenGL.floatToGPU(shaderID, "displacementIntensity", displacementIntensity);
		RenderOrganizer.bindTexture(4, texture.getSpecularMapID());
		...
		Lighting(shaderID);
		Fog(shaderID);
		OpenGL.floatToGPU(shaderID, "numOfInstancesWide", (float)numOfInstancesWide);
		...
		OpenGL.drawElementsInstanced(GL_PATCHES, vao.indicesLength, GL_UNSIGNED_INT, 0L, numOfInstances);
		//OpenGL.culling(true);
